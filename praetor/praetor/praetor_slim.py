...
def get_arguments():
    ...
    parser.add_argument('--praetor-function-blacklist',required=False, help='Comma separated list of functions to blacklist',
                        type=list_of_strings)
    parser.add_argument('--praetor-module-blacklist',required=False, help='Comma separated list of modules to blacklist',
                        type=list_of_strings)
    ...
    return {"out_dir": output_directory, "func_blacklist": function_blacklist, "module_blacklist": module_blacklist,
            "big_entities": big_entities, "cpython": cpython, "bootstrap": bootstrap, "process_monitor": process_monitor}
...
tracer = CallTracer(output_directory=arg_dict["out_dir"], slim=True, process_monitor=arg_dict["process_monitor"],
                    ...
                    store_large_values=arg_dict["big_entities"], cpython=arg_dict["cpython"], bootstrap=arg_dict["bootstrap"])
